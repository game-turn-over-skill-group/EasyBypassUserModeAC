...
public:
    ...
    static NTSTATUS NTAPI NtReadVirtualMemory(
        IN HANDLE ProcessHandle, 
    ...
    static NTSTATUS NTAPI Undocumented::NtCreateFile(
        PHANDLE            FileHandle,
        ACCESS_MASK        DesiredAccess,
        POBJECT_ATTRIBUTES ObjectAttributes,
    ...
    static HANDLE NTAPI Undocumented::NtUserQueryWindow(
        HWND WindowHandle,
        HANDLE TypeInformation
    );

    
    static HWND NTAPI NtUserFindWindowEx(HWND hWndParent, HWND hWndChildAfter, PUNICODE_STRING lpszClass, PUNICODE_STRING lpszWindow, DWORD dwType);
    static NTSTATUS NTAPI NtUserBuildHwndList(HDESK hDesktop, HWND hwndParent, BOOL bChildren, BOOL  RemoveImmersive, ULONG dwThreadId, ULONG lParam, HWND* pWnd, PULONG pBufSize);
    static HWND NTAPI NtUserGetForegroundWindow();
